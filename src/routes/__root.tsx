...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "ProjectAtlas — AI-powered catalogue for developer projects" },
      { name: "description", content: "Drop a URL. ProjectAtlas crawls, understands, and showcases your project automatically." },
    ],
